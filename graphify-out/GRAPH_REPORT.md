...
## Summary
- 627 nodes · 1154 edges · 35 communities (31 shown, 4 thin omitted)
...
- `InClassScreen()` --calls--> `MeetingChatPanel()`  [INFERRED]
...
Cohesion: 0.13
Nodes (13): AuditLogEntry, MediaState, OFF, ON, ParticipantRole, ADMIN, STARCAST, STUDENT (+5 more)

### Community 16 - "MeetingComponents.kt"
Cohesion: 0.27
Nodes (12): Participant, ControlButton(), ImageVector, Modifier, MeetingControlBar(), ParticipantRow(), ParticipantsPanel(), StatusDot() (+4 more)
...
- **Why does `AppNavHost()` connect `AppNavHost` to `HomeScreen.kt`, `ChatScreen.kt`, `MainActivity`, `QuizTakingScreen.kt`, `PracticeScreen.kt`, `MeetingComponents.kt`, `DeviceSecurityChecker`?**
  _High betweenness centrality (0.198) - this node is a cross-community bridge._
- **Why does `MainActivity` connect `MainActivity` to `Resource`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `MeetingViewModel` connect `MeetingViewModel` to `AppNavHost`, `WhiteboardTool`, `MeetingModels.kt`, `MeetingComponents.kt`, `MeetingChatPanel`?**
