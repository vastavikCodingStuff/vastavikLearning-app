...
## Corpus Check
- 133 files · ~114,650 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1219 nodes · 2542 edges · 68 communities (58 shown, 10 thin omitted)
...
Cohesion: 0.09
Nodes (19): getCanonicalOutputAndTrace(), isAnswerMatching(), OutputQuestion, PredictOutputSetScreen(), FirebaseMessagingService, Intent, MeetingForegroundService, MeetingNotificationManager (+11 more)

### Community 4 - "MainActivity"
Cohesion: 0.05
Nodes (31): Intent, MainActivity, Modifier, TelegramNotificationCard(), TelegramNotificationHost(), androidx, ImageVector, SectionHeader() (+23 more)

### Community 5 - "PracticeScreen.kt"
Cohesion: 0.08
Nodes (50): ChatSyntaxColors, highlightCode(), androidx, Color, Modifier, MarkdownSegment, parseBasicMarkdown(), ParsedMarkdownText() (+42 more)
...
### Community 7 - "OcrExerciseScreen.kt"
Cohesion: 0.46
...
Cohesion: 0.10
Nodes (12): Result, T, AppUpdateResponse, CurriculumResponse, HomeCatalogResponse, LessonResponse, NoteResponse, PYQResponse (+4 more)
...
### Community 34 - "WebSocketListener"
Cohesion: 0.48
...
Cohesion: 0.15
Nodes (11): BannerItem, ChatHistoryItem, ChatRequest, ChatResponse, CourseItem, CreateOrderRequest, CreateOrderResponse, NoteCreateRequest (+3 more)
...
Cohesion: 0.06
Nodes (28): callVastavikAiChat(), com, CodeEditorScreen(), defaultCode(), getStructuredSections(), highlightCode(), parseProblemSections(), ProblemSection (+20 more)
...
- **Why does `brutalBorderColor()` connect `brutalBorderColor` to `PredictOutputSetScreen.kt`, `MainActivity`, `PracticeScreen.kt`, `Resource`, `OcrExerciseScreen.kt`, `CommonComponents.kt`, `AppUpdater`, `QuizTakingScreen.kt`, `WhiteboardTool`, `Participant`?**
  _High betweenness centrality (0.169) - this node is a cross-community bridge._
- **Why does `brutalShadowColor()` connect `brutalBorderColor` to `PredictOutputSetScreen.kt`, `MainActivity`, `PracticeScreen.kt`, `AppUpdater`, `OcrExerciseScreen.kt`, `CommonComponents.kt`, `QuizTakingScreen.kt`, `WhiteboardTool`, `Participant`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `LessonModel` connect `VastavikApiService` to `CommonComponents.kt`, `LearningViewModel`, `FirestoreRepository`, `neoShape`, `VideoLessonViewModel.kt`?**
...
- **Should `PredictOutputSetScreen.kt` be split into smaller, more focused modules?**
